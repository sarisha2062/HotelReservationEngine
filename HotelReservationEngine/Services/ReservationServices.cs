...
namespace HotelReservationEngine.Services
{
    public class ReservationService : IReservationService
    {
        ...
        public Reservation CreateReservation(Reservation reservation)
        {
            ...
            // Calculate total price based on dynamic pricing
        ...
        {
            // Check for overlapping reservations or double bookings
        ...
        public decimal CalculatePrice(int roomId, DateTime checkIn, DateTime checkOut)
        {
            ...
            while (currentDate < checkOut.Date)
            {
                ...
                {
                    totalPrice += room.BasePrice * 1.5m; // 50% higher on weekends
                }
                else
                {
